...
ActiveRecord::Schema[8.0].define(version: 2025_06_19_151136) do
  ...
  create_table "candidate_statuses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.date "offer_accepted_on"
    t.date "offer_rejected_on"
  ...
  create_table "goals", force: :cascade do |t|
    ...
    t.index ["manager_id"], name: "index_goals_on_manager_id"
  end
  ...
  create_table "onboard_tasks", force: :cascade do |t|
    t.string "name"
    ...
    t.datetime "updated_at", null: false
    t.boolean "complete"
    t.bigint "onboard_checklist_id", null: false
    t.index ["assignee_id"], name: "index_onboard_tasks_on_assignee_id"
    t.index ["onboard_checklist_id"], name: "index_onboard_tasks_on_onboard_checklist_id"
    t.index ["tags"], name: "index_onboard_tasks_on_tags", using: :gin
  end
  ...
  create_table "onboarding_events", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "location"
    t.index ["contact_id"], name: "index_onboarding_events_on_contact_id"
    t.index ["manager_id"], name: "index_onboarding_events_on_manager_id"
    t.index ["new_joiner_id"], name: "index_onboarding_events_on_new_joiner_id"
  end
  ...
  create_table "personal_development_plans", force: :cascade do |t|
    t.bigint "employee_id", null: false
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "pulse_questions", force: :cascade do |t|
    t.string "title"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  add_foreign_key "onboard_tasks", "employees", column: "assignee_id"
  add_foreign_key "onboard_tasks", "onboard_checklists"
