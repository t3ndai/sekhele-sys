...
organization = Organization.find(1)
  ...
  3.times do
    ...
    job_function = JobFunction.find_or_create_by(department: department, organization: organization, title: Faker::Job.title)
    JobLevel.find_or_create_by(name: levels.sample, job_function: job_function)
  end
end
