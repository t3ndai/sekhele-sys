...
task employee_locations: :environment do
  p "Create Locations"
  organization = Organization.find(1)
  4.times do
    Location.create(name: Faker::Fantasy::Tolkien.location, organization: organization, addr_line1: Faker::Address.street_address, city: Faker::Address.city, country: Faker::Address.country_by_code(code: "ZW"))
  end
