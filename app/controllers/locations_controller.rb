class LocationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @location.save
        format.html { redirect_to organization_hr_admin_path(@organization), notice: "Location was successfully created." }
  ...
  def update
    respond_to do |format|
      if @location.update(location_params)
        format.html { redirect_to organization_hr_admin_path(@organization), notice: "Location was successfully updated." }
