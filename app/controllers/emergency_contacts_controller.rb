class EmergencyContactsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @emergency_contact.save
        format.html { redirect_to @employee, notice: "Emergency contact was successfully created." }
  ...
  def update
    respond_to do |format|
      if @emergency_contact.update(emergency_contact_params)
        format.html { redirect_to @emergency_contacte.employee, notice: "Emergency contact was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to emergency_contacts_path, status: :see_other, notice: "Emergency contact was successfully destroyed." }
  ...
  private
    ...
    def set_emergency_contact
      @emergency_contact = EmergencyContact.find(params.expect(:id))
    end
    ...
    def emergency_contact_params
      params.expect(emergency_contact: [ :employee_id, :first_name, :last_name, :phone1, :phone2, :addr_line1, :addr_line2, :addr_lin3, :city, :postcode, :country ])
    end
end
