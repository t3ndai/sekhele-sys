...
class ActionItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create action_item" do
    assert_difference("ActionItem.count") do
      post action_items_url, params: { action_item: { completed: @action_item.completed, name: @action_item.name, one_to_one_id: @action_item.one_to_one_id } }
    end
  ...
  test "should update action_item" do
    patch action_item_url(@action_item), params: { action_item: { completed: @action_item.completed, name: @action_item.name, one_to_one_id: @action_item.one_to_one_id } }
