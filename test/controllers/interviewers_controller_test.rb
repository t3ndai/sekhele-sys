...
class InterviewersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interviewer" do
    assert_difference("Interviewer.count") do
      post interviewers_url, params: { interviewer: { assigned_on: @interviewer.assigned_on, employee_id: @interviewer.employee_id, interview_id: @interviewer.interview_id } }
    end
  ...
  test "should update interviewer" do
    patch interviewer_url(@interviewer), params: { interviewer: { assigned_on: @interviewer.assigned_on, employee_id: @interviewer.employee_id, interview_id: @interviewer.interview_id } }
