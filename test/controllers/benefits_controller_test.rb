...
class BenefitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create benefit" do
    assert_difference("Benefit.count") do
      post benefits_url, params: { benefit: { benefit_type_id: @benefit.benefit_type_id, name: @benefit.name, organization_id: @benefit.organization_id, valuation_type: @benefit.valuation_type } }
    end
  ...
  test "should update benefit" do
    patch benefit_url(@benefit), params: { benefit: { benefit_type_id: @benefit.benefit_type_id, name: @benefit.name, organization_id: @benefit.organization_id, valuation_type: @benefit.valuation_type } }
