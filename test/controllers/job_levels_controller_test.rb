...
class JobLevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_level" do
    assert_difference("JobLevel.count") do
      post job_levels_url, params: { job_level: { job_function_id: @job_level.job_function_id, name: @job_level.name } }
    end
  ...
  test "should update job_level" do
    patch job_level_url(@job_level), params: { job_level: { job_function_id: @job_level.job_function_id, name: @job_level.name } }
