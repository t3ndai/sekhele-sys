...
class JobPostingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_posting" do
    assert_difference("JobPosting.count") do
      post job_postings_url, params: { job_posting: { date_close: @job_posting.date_close, date_open: @job_posting.date_open, num_positions: @job_posting.num_positions, organization_id: @job_posting.organization_id } }
    end
  ...
  test "should update job_posting" do
    patch job_posting_url(@job_posting), params: { job_posting: { date_close: @job_posting.date_close, date_open: @job_posting.date_open, num_positions: @job_posting.num_positions, organization_id: @job_posting.organization_id } }
